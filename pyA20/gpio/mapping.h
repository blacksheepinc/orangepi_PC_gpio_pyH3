...
*/  {"gpio1",
        {
            {   "GPIO02",  SUNXI_GPA(12),  3   },
            {   "GPIO03",  SUNXI_GPA(11),  5   },
            {   "GPIO04",  SUNXI_GPA(6),  7   },
            {   "GPIO17",  SUNXI_GPA(0),   11 },
            {   "GPIO27",  SUNXI_GPA(1),   13   },
            {   "GPIO22",  SUNXI_GPA(3),   15   },
            {   "GPIO10",  SUNXI_GPC(0),   19   },           
	    {   "GPIO09",  SUNXI_GPC(1),  21   },
            {   "GPIO11",  SUNXI_GPC(2),  23   },
            {   "PA19",  SUNXI_GPA(19),  27   },
            {   "GPIO05",  SUNXI_GPA(7),   29 },
            {   "GPIO06",  SUNXI_GPA(8),   31   },
            {   "GPIO13",  SUNXI_GPA(9),   33   },
            {   "GPIO19",  SUNXI_GPA(10),   35   },
            {   "GPIO26",  SUNXI_GPA(20),  37  },
            ...
            {   "GPIO08",  SUNXI_GPC(3),  24   },
            {   "GPIO07",  SUNXI_GPA(21),  26   },
